  ...
  methods:{
    ...
    openModal(isNew,item) {
      if (isNew) {
        ...
        this.tempCoupon = Object.assign({}, item); //因物件會傳參考的關係要用空物件
        this.isNew = false;
      }
    ...
    addCoupon(){
      const vm = this;
      let api =
        "https://vue-course-api.hexschool.io/api/wendywu007/admin/coupon";
      let httpMethod = "post";
      if (!vm.isNew) {
        api = `https://vue-course-api.hexschool.io/api/wendywu007/admin/coupon/${vm.tempCoupon.id}`;
        httpMethod = "put";
      }
